...
class PreProcess:
    ...
    def __init__(self, catalog, f_names=None):
        ...
        I was inspired by examples on Python Tutorial(2020) os — Miscellaneous operating system interfaces on 01/10/2020
        Availability: https://docs.python.org/3/library/os.html?highlight=os#os.fsencode
        I was inspired by X. Zhou(2020) Three methods of Python traversing directory folder and file are explained in de
        tail on 07/10/2020
        Availability: https://blog.csdn.net/qq_39839807/article/details/104070761?biz_id=102&utm_term=os.scandir&utm_med
        ium=distribute.pc_search_result.none-task-blog-2~all~sobaiduweb~default-4-104070761&spm=1018.2118.3001.4187
        """
        if f_names is None:
    ...
    """
    For the following code blocks
    I was inspired by C. Shan(2017) Three methods of reading TXT file in Python on 08/10/2020
    Availability: https://blog.csdn.net/shandong_chu/article/details/70173952
    """
    ...
    """
    For the following code blocks
    I was inspired by D. Mendha(2020) Assignment 1 Sample Solution/Contact_Book on 08/10/2020
    Availability: https://lms.monash.edu/course/view.php?id=78169&section=5
    """
